...
let print_rtlinstr fmt = function
  ...
  | Embinop (op, r1, r2, l) -> fprintf fmt "%a %a %a;  goto %a" print_mbinop op Register.print r1 Register.print r2 Label.print l
  | Emubranch (op, r, l1, l2) -> fprintf fmt "%a %a;  goto %a, %a" print_mubranch op Register.print r Label.print l1 Label.print l2
  | Embbranch (op, r1, r2, l1, l2) -> fprintf fmt "%a %a %a;  goto %a, %a" print_mbbranch op Register.print r1 Register.print r2 Label.print l1 Label.print l2
  | Ecall (r, x, rl, l) -> fprintf fmt "%a <- call %s(@[%a@]);  goto %a" Register.print r x (print_list comma Register.print) rl Label.print l
